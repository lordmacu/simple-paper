...
/// welcome name screen/widget
class WelcomeNameScreen extends ConsumerStatefulWidget {
  /// Crea una instancia de welcome name screen.
  const WelcomeNameScreen({required this.onFinished, super.key});
